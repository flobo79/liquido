<?php /* Smarty version 2.6.9, created on 2010-09-28 09:14:50
         compiled from /Webserver/vwclub.local/htdocs/liquido/components/contents/detail/templates/head.tpl */ ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<title>liquido</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<link href="<?php echo $this->_tpl_vars['LIQUIDO']; ?>
/css/liquido.css" rel="stylesheet" type="text/css">
...
<!--
	<?php if ($this->_tpl_vars['update_leftframe']): ?> //parent.left.location.href = 'left_pane.php?noupdate=1';<?php endif; ?>
//-->

<?php echo '
	
	var sortChilds = false;
	var pageId = \'';  echo $this->_tpl_vars['data']['id'];  echo '\';
	...
	var pageid = '<?php echo $this->_tpl_vars['data']['id']; ?>
'; 
	var pagetitle = '<?php echo $this->_tpl_vars['data']['title']; ?>
'; 
	<?php echo '
