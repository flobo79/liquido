...
<script language="JavaScript" type="text/javascript">
	function loadstats_year(jahr) {ldelim}
		document.year.src='gfx/stats_dates_year-sample.png';
	{rdelim}
	function loadstats_places(monat,jahr) {ldelim}
		document.month.src='gfx/stats_dates_place-sample.png';
	{rdelim}
</script>
<div align="center">
<form name="stats" id="stats" method="post" action="">
  ...
  <p><img src="gfx/stats_dates_year-sample.png" id="year" name="year" /></p>
  Zeitraum w&auml;hlen: 
  ...
  <p><img src="gfx/stats_dates_place-sample.png" id="month" name="month" /></p>
</form>
</div>
{if false}
</body>
