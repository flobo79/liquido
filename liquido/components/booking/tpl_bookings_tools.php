...
?>
  ...
  <select name="selection" onchange="showselection(this.options[this.selectedIndex].value);">
    ...
    <option value="notannounceconfirmsend">Buchungsbestätigung nicht versandt</option>
    <option value="notannounceconfirmrecv">Buchungsbestätigung nicht erhalten</option>
    ...
    <option value="multimarkannounceconfirmsend">Buchungsbestätigung versandt</option>
    <option value="multimarkannounceconfirmnotsend">Buchungsbestätigung nicht versandt</option>
    <option value="multimarkannounceconfirmrecv">Buchungsbestätigung erhalten</option>
    <option value="multimarkannounceconfirmnotrecv">Buchungsbestätigung nicht erhalten</option>
  </select>
</div>
