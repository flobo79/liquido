...
if($_FILES['addimage']['size'] != 0) {
	...
	copy($source, $_SERVER['DOCUMENT_ROOT']."/sendcard/images/".$filename);
}
...
$images = listImages($_SERVER['DOCUMENT_ROOT']."/sendcard/images/");
$phrases = listPhrases();
	...
	if(is_array($images)) {
		foreach($images as $file) {
			echo "<td align=\"center\" width=\"55\" height=\"50\">
				<a href=\"#\" onClick=\"window.open('popup.php?file=$file','details','height=400,width=450');\"><img src=\"/sendcard/images/$file\" border=\"0\" width=\"50\"></a><br>\n
			</td>";
			$i++;
			if($i == $max) {
				echo "</tr><tr>\n";
