...
<form name="form1" method="post" action="<?php echo $formaction ?>">
  <table width="100%" border="0" cellpadding="1" cellspacing="0">
    <tr> 
      ...
      <td width="110" valign="top"><img src="gfx/swf_big.gif" border="0"><br> 
        <br> <br>
        [<a href="list_details.php?id=<?php echo $id ?>">abbrechen</a>] <br></td>
...
?>
          <br>
          Soll das Dokument <b><?php echo $result['name'] ?></b> <br>
...
?>
        ...
        <p><br>
          Dieses Dokuement hat folgende Verwendungen:<br>
        </p>
...
?>
          <br>
          Dokument wurde gel&ouml;scht<span class="headline"> </span></p>
        <p> 
